...
import 'package:davipel_comex/helpers/navigation_helper.dart';
...
void main() async {
  ...
  if (prefs.containsKey('isOnboardingCompleted')) {
    isOnboardingCompleted = (prefs.getBool('isOnboardingCompleted'))!;
  }
  runApp(
    MultiProvider(
      providers: [
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      initialRoute: isOnboardingCompleted
          ? RoutingConstants.authCheck
          : RoutingConstants.productSelection,
